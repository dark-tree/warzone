...
public class VertexAttribute {
	 ...
	 * @param stride - offset from the beginning of the vertex to the end of it, in floats
	 * @param offset - offset from the beginning of the vertex to start of this attribute, in floats
	 */
	public static void glVertexAttribute(int index, int length, int stride, int offset) {
		GL32.glVertexAttribPointer(index, length, GL32.GL_FLOAT, false, stride * FLOAT, (long) offset * FLOAT);
	...
	public void apply(int index, int stride, int offset) {
		glVertexAttribute(index, this.length, stride, offset);
	}
