...
public class ConfirmScreen extends AcceptScreen {
	...
	protected void buildButtonModel(ModelBuilder builder) {
		builder.add(1, 1, UiButton.of(TEXT_YES).box(6, 2).inset(0.1f, -0.2f).react(() -> runAction(true)));
		builder.add(11, 1, UiButton.of(TEXT_NO).box(6, 2).inset(0.1f, -0.2f).react(() -> runAction(false)));
	}
